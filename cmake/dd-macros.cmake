...
# Point to QT 5 for Ubuntu 22.04
macro(setup_qt)
  get_ubuntu_version()

  set(_default_qt_version 5)
  if (ubuntu_version EQUAL 22.04)
    set(_default_qt_version 5)
  endif()
...
# Dependencies based on what QT 5.x was used.
macro(qt_wrap_ui)
  if(DD_QT_VERSION EQUAL 4)
    qt4_wrap_ui(${ARGN})
  else()
...
macro(use_cpp14)
  if (CMAKE_COMPILER_IS_GNUCC)
    ...
    if (NOT (GCC_VERSION VERSION_GREATER 4.8 OR GCC_VERSION VERSION_EQUAL 4.8))
      message(FATAL_ERROR "requires gcc version >= 4.8")  # to support the c++14 flag below
    elseif(GCC_VERSION VERSION_LESS 5.0)
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++1y")  # For GCC < 5.0, use the experimental C++14 flag
    else()
